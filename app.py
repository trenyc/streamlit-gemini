...
st.session_state.categorized_comments = {category: [] for category in categories}
st.session_state.top_voted_comments = {category: None for category in categories}
st.session_state.previously_rendered_comments = {category: [] for category in categories}
...
def create_prompt_for_category(comments, category):
    ...
    for comment in comments:
        ...
        if len(prompt) + len(comment_text) + 2 > token_limit: 
